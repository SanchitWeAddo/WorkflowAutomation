...
import {
  LayoutDashboard, Users, Building2, FolderKanban, Plug, ScrollText,
  Menu, X, LogOut, Bell, User, BarChart3,
} from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        <div className="flex h-16 items-center justify-between px-4">
          <h1 className="text-lg font-bold tracking-tight">PIH Admin</h1>
